...
function [muon_allch_out] = muonconverter(data_in_path, pt, ch_start, ch_finish, plot_out_path, landau_flag, fig_on, bin_width)
    ...
    if landau_flag
        histfitlandau(muon_allch(muon_allch>100), bin_width, 0, 6000, 1); % bin_width = 15
    else
